  ...
  const actions = useMemo(
    () => ({
      ...
      deleteMaterial: (id: string) =>
        setMaterials((prev) => removeMaterial(prev, id)),
      ...
      deleteProcess: (id: string) =>
        setProcesses((prev) => removeProcess(prev, id)),
      ...
      deleteSetupCost: (id: string) =>
        setSetupCosts((prev) => removeSetupCost(prev, id)),
      ...
      deleteOtherCost: (id: string) =>
        setOtherCosts((prev) => removeOtherCost(prev, id)),
