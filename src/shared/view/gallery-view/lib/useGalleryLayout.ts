...
export const useGalleryLayout = (layoutConfig: GalleryLayoutConfig) => {
  ...
  const gridClasses = useMemo((): GridClass => {
    ...
    if (layoutConfig.grid.sm) classes.push(`sm:grid-cols-${layoutConfig.grid.sm}`);
    if (layoutConfig.grid.md) classes.push(`md:grid-cols-${layoutConfig.grid.md}`);
    if (layoutConfig.grid.lg) classes.push(`lg:grid-cols-${layoutConfig.grid.lg}`);
    if (layoutConfig.grid.xl) classes.push(`xl:grid-cols-${layoutConfig.grid.xl}`);
