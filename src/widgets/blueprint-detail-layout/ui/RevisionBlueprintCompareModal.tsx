...
import { BlueprintView, BasicInformation, EstimateInformation } from "../model/types";
import { RevisionBlueprint } from "../model/revisionBlueprintTypes";
import { EditableComparisonField, ReadOnlyComparisonField } from "@/page-components/blueprint/similar/lib/comparison-field-components";
...
export function RevisionBlueprintCompareModal({
  ...
  // Use the revision blueprint data directly since it now contains basicInformation and estimateInformation
  const revisionBlueprintData = {
    basicInformation: revisionBlueprint.basicInformation || {},
    estimateInformation: revisionBlueprint.estimateInformation || {}
  };
          ...
          <TabsContent value="estimate" className="flex-1 overflow-hidden mt-0">
            <div className="h-full overflow-y-auto">
              ...
              <div className="p-4 pb-2 flex gap-1">
                ...
                <div className="flex-1">
                  <h4 className="text-base font-semibold text-blue-900 border-b-2 border-blue-300 pb-3 bg-blue-50/50 px-3 py-2 rounded-t-lg">リビジョン図面</h4>
                </div>
              </div>
              ...
              <div className="flex p-4 pt-2 gap-1">
                ...
                <div className="flex-1 bg-blue-50 rounded-lg overflow-hidden p-4 flex items-center justify-center">
                  <img
                    src={revisionBlueprint.imageUrl}
                    alt={revisionBlueprint.name}
                    className="max-w-full max-h-full object-contain rounded border"
                  />
                </div>
              </div>
                    ...
                    {estimateInputFields.map((field) => (
                      <div key={field.key} className="flex flex-col space-y-1">
                        ...
                        <ReadOnlyComparisonField
                          value={revisionBlueprintData.estimateInformation?.[field.key] || ''}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {basicInputFields.map((field) => (
                      <div key={field.key} className="flex flex-col space-y-1">
                        ...
                        <ReadOnlyComparisonField
                          value={revisionBlueprintData.basicInformation?.[field.key] || ''}
