    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="min-w-4xl">
        ...
        <div className="grid grid-cols-2 gap-6 py-6">
          ...
          <div
            className="h-full border-2 border-dashed border-gray-300 rounded-lg hover:border-gray-400 transition-colors cursor-pointer flex flex-col items-center justify-center space-y-4"
