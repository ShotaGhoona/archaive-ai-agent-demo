...
interface DirectoryInfoFormProps {
  directoryData: Directory;
  onUpdate: (data: Partial<Directory>) => void;
  onSave: () => void;
  isLoading: boolean;
}

export function DirectoryInfoForm({
  directoryData,
  onUpdate,
  onSave,
  isLoading,
}: DirectoryInfoFormProps) {
  return (
