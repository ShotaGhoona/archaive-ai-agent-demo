...
export function UploadPageHeader({
  ...
  const isAllSelected =
    viewMode === 'uploaded'
      ? selectedFiles.length === uploadedFilesCount &&
        selectedStacks.length === stacksCount &&
        (uploadedFilesCount > 0 || stacksCount > 0)
    ...
    <div className='flex items-center justify-between'>
      <div className='flex items-center gap-4'>
        ...
        <Tabs
          value={viewMode}
          onValueChange={(value) =>
            onViewModeChange(value as 'uploaded' | 'trash')
          }
        >
          <TabsList className='h-10'>
            ...
            <TabsTrigger value='trash' className='flex h-8 items-center gap-1'>
      ...
      <div className='flex items-center gap-2'>
        ...
        <div className='flex items-center gap-2'>
          ...
          {hasAnySelection && (
            <Button variant='outline' size='lg' onClick={onDeselectAll}>
        ...
        {viewMode === 'uploaded' && canStackItems && (
          <Button variant='default' size='lg' onClick={onStackFiles}>
        ...
        {hasAnySelection && (
          <Button
            ...
            size='lg'
            onClick={
              viewMode === 'uploaded' ? onRemoveSelected : onRestoreSelected
            }
            className={
              viewMode === 'uploaded'
