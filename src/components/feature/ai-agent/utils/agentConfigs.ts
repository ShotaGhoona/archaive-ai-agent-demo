...
export const availableAgents: Record<string, AIAgentConfig> = {
  general: {
    ...
    quickActions: [
      { id: 'help', label: '使い方を教えて', icon: HelpCircle, action: '使い方を教えて' },
      { id: 'search', label: '図面を検索', icon: MessageCircle, action: '図面を検索' },
      { id: 'calculate', label: '寸法を計算', icon: Calculator, action: '寸法を計算' }
    ]
  },
  estimate: {
    id: 'estimate',
    ...
    quickActions: [
      { id: 'estimate', label: '見積もり開始', icon: Calculator, action: '見積もり開始' },
      { id: 'materials', label: '材料費を確認', icon: MessageCircle, action: '材料費を確認' },
      { id: 'timeline', label: '納期を確認', icon: MessageCircle, action: '納期を確認' }
    ]
  },
  process: {
    id: 'process',
